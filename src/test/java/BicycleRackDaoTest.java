...
class BicycleRackDaoTest {
    ...
    void createRecordStudentIdExceedsMaxLength() {
        ...
        Exception exception = assertThrows(IllegalArgumentException.class, () -> {
            dao.createRecord("a".repeat(studentIdMaxLength + 1), "amadeus", "oxford");
        });
    ...
    void createRecordStudentNameExceedsMaxLength() {
        ...
        Exception exception = assertThrows(IllegalArgumentException.class, () -> {
            dao.createRecord("4", "a".repeat(studentNameMaxLength + 1), "oxford");
        });
    ...
    void createRecordBicycleDescriptionExceedsMaxLength() {
        ...
        Exception exception = assertThrows(IllegalArgumentException.class, () -> {
            dao.createRecord("4", "amadeus", "a".repeat(bicycleDescriptionMaxLength + 1));
        });
    ...
    void createRecordExceedsBicycleRackMaxCapacity() {
        ...
        Exception exception = assertThrows(IllegalStateException.class, () -> {
            dao.createRecord(String.valueOf(bicycleRackMaxCapacity), "amadeus", "oxford");
        });
